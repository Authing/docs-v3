  ...
  themeConfig: {
    ...
    locales: {
      '/': {
        ...
        oldVersion: '旧版',
        nav: [
          { text: '快速开始', link: '/v2/quickstarts/' },
          { text: '概念', link: '/v2/concepts/' },
          { text: '使用指南', link: '/v2/guides/' },
          {
            text: '开发集成',
            link: '/reference/',
            tag: 'V3',
          ...
          sections: [
            {
              ...
              links: [
                ...
                {
                  text: '通用登录表单组件',
                  link: 'v2/reference/ui-components/'
                },
                {
                  text: '自定义认证流程',
                  link: 'v2/guides/pipeline/'
                }
              ]
            },
            {
              ...
              links: [
                {
                  text: '单点登录',
                  link: 'v2/guides/app-new/sso/'
                },
                {
                  text: '多因素认证',
                  link: 'v2/guides/security/mfa/'
                },
                {
                  text: '权限管理',
                  link: 'v2/guides/access-control/'
                }
              ]
            },
            {
