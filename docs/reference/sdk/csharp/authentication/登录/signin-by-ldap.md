...
| ---- | ---- | ---- | ---- | ---- | ---- |
| sAMAccountName | String | 是 | - | LDAP 用户目录中账号的 sAMAccountName | `test` |
...
namespace ConsoleApplication
{
    public class Program
    {
        ...
        private static async Task MainAsync()
        {
            ...
            var res = await authenticationClient.signInByLDAP("AUTHING_LDAP_ACCOUNT", "AUTHING_LDAP_ACCOUNT_PASSWORD");
        }
    }
}
```
