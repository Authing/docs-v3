...
`ManagementClient.create_or_update_group`
...
| data | <a href="#CreateOrUpdateGroupDataDto">CreateOrUpdateGroupDataDto</a> | 响应数据 |
...
| ---- |  ---- | ---- | ---- | ---- |
| created | boolean | 是 | 是否创建   |  `true` |
| data |  | 是 | 群组信息 嵌套类型：<a href="#GroupDto">GroupDto</a>。  |  |
