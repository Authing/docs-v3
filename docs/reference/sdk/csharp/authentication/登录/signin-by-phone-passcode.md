...
| ---- | ---- | ---- | ---- | ---- | ---- |
| phone | String | 是 | - | 手机号 | `188xxxx8888` |
| phoneCountryCode | String | 否 | - | 手机号区号 | `+86` |
| passCode | String | 是 | - | 短信验证码  | `1234` |
...
namespace ConsoleApplication
{
    public class Program
    {
        ...
        private static async Task MainAsync()
        {
            ...
            var res2 = await authenticationClient.SignUpByPhoneCode("AUTHING_PHONE", "AUTHING_CODE",
