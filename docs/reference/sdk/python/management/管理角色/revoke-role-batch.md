...
`ManagementClient.revoke_role_batch`

## 请求参数

| 名称 | 类型 | <div style="width:80px">是否必填</div> | <div style="width:60px">默认值</div> | <div style="width:300px">描述</div> | <div style="width:200px">示例值</div> |
| ---- | ---- | ---- | ---- | ---- | ---- |
| targets | <a href="#TargetDto">TargetDto[]</a> | 是 | - | 移除角色的目标列表 数组长度限制：50。 | `[{"targetIdentifier":"60b49eb83fd80adb96f26e68","targetType":"USER"}]` |
| roles | <a href="#RoleCodeDto">RoleCodeDto[]</a> | 是 | - | 角色信息列表 数组长度限制：10。 | `[{"code":"60b49eb83fd80adb96f26e68","namespace":"namespaceCode"}]` |
