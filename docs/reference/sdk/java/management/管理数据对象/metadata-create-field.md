...
| dropDown | <a href="#DropDownItemDto">DropDownItemDto</a> | 是 | - | 下拉菜单选项  |  |
...
| type | string | 是 | - | 字段类型:<br>    - 1: 单行文本<br>    - 2: 多行文本<br>    - 3: 数字<br>    - 4: 布尔类型<br>    - 5: 日期<br>    - 6: 枚举<br>    - 7: 关联类型<br>    - 8: 反向关联数据展示<br>      |  |
| key | string | 是 | - | 字段属性名  |  |
| name | string | 是 | - | 字段名称  |  |
