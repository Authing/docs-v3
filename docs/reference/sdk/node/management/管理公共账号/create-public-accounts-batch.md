...
| ---- |  ---- | ---- | ---- | ---- |
| status | string | 否 | 账户当前状态   | Suspended |
...
| otp |  | 否 | 公共账号的 OTP 验证器 嵌套类型：<a href="#CreatePublicAccountOtpDto">CreatePublicAccountOtpDto</a>。  |  `{"recoveryCode":"b471-8ec0-874a-087f-bccb-cd54","secret":"HZ2F6J3AGNAVSOTV"}` |
...
| options |  | 否 | 可选参数 嵌套类型：<a href="#CreatePublicAccountOptionsDto">CreatePublicAccountOptionsDto</a>。  |  `{"autoGeneratePassword":true,"resetPasswordOnFirstLogin":true,"passwordEncryptType":"none"}` |
