...
| tenantIds | string[] | 否 | - | 租户 ID  | `["63f867961cxxxx41e7ccb582","63bea7828f4xxxxbfa80df93"]` |
| otp | <a href="#CreateUserOtpDto">CreateUserOtpDto</a> | 否 | - | 用户的 OTP 验证器  | `{"recoveryCode":"b471-8ec0-874a-087f-bccb-cd54","secret":"HZ2F6J3AGNAVSOTV"}` |
