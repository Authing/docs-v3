...
| operationType | string | 是 | 操作类型：<br>- `create`: 创建<br>- `delete`: 删除<br>- `import`: 导入<br>- `export`: 导出<br>- `update`: 修改<br>- `refresh`: 刷新<br>- `sync`: 同步<br>- `invite`: 邀请<br>- `resign`: 离职<br>- `recover`: 恢复<br>- `disable`: 禁用<br>- `userEnable`: 启用<br>       | all |
