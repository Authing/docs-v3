...
| tenantIds | array | 否 | 租户 ID   |  `["63f867961cxxxx41e7ccb582","63bea7828f4xxxxbfa80df93"]` |
| otp |  | 否 | 用户的 OTP 验证器 嵌套类型：<a href="#CreateUserOtpDto">CreateUserOtpDto</a>。  |  `{"recoveryCode":"b471-8ec0-874a-087f-bccb-cd54","secret":"HZ2F6J3AGNAVSOTV"}` |
...
| metadataSource | object | 否 | 数据对象数据，传入的对象中的 key 必须先在用户池定义相关自定义字段   |  `{"school":"北京大学","age":22}` |
