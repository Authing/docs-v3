  ...
  themeConfig: {
    ...
    locales: {
      '/': {
        ...
        oldVersion: '旧版',
        nav: [
          { text: '快速开始', link: 'https://docs.authing.cn/v2/quickstarts/' },
          { text: '概念', link: 'https://docs.authing.cn/v2/concepts/' },
          { text: '使用指南', link: 'https://docs.authing.cn/v2/guides/' },
          {
            text: '开发集成',
            link: '/reference/',
            tag: 'V3',
          ...
          {
            text: '应用集成',
            link: 'https://docs.authing.cn/v2/integration/'
          },
          {
            text: '身份自动化',
            link: 'https://docs.authing.cn/v2/workflow/'
          },
          {
            text: '加入 APN',
            link: 'https://docs.authing.cn/v2/apn/'
          },
          {
            link: 'https://docs.authing.cn/v2/reference-new/',
            text: '开发集成',
            hidden: true
          },
          {
            link: 'https://docs.authing.cn/v2/tenant/',
            text: '多租户（内测版）',
            hidden: true
          },
          {
            link: 'https://docs.authing.cn/v2/console-using/',
            text: '控制台文档',
            hidden: true
          }
        ],
